...
#let pathogen-opportunistic-bacteria(report) = page(
  ...
  #table(
    ...
    inset: (x: 0.7em, y: 1em),
    table.header(
      [Bacterial\ Pathogens], [Result], [Reference], [Role / Gut & Host Function / Impact], [Retest Interval\*]
    ),
    ..for pathogen in report.pathogens {
      (
        ...
        align(center + horizon, if pathogen.reference_range.lower == none {
          ...
          [#numfmt(pathogen.reference_range.lower)-\ #numfmt(pathogen.reference_range.upper)]
        }),
