...
#let report-introduction(section, report) = [
  ...
  #page(background: {
    ...
    == 標準化益生菌的局限性
    雖然市場上許多益生菌産品提供了通用的「有益菌」，但大多數是標準化的，也就是説，它們為每個人提供相同的菌株和劑量。然而，每個人的腸道微生物群都是獨特的，由飲食、生活方式和健康狀況等個體因素所塑造。標準化的益生菌並未考慮這些差異，往往導致要反覆試驗和錯誤的試用以及參差不齊的效果。此外，它們可能缺乏解決特定腸道失衡所需的特定菌株或組合，限制了它們在改善個人健康需求方面的有效性。
